...
# Encode images
left_wheel = get_image_base64("color.jpg")
heading = get_image_base64("heading.jpg")
right_wheel = get_image_base64("color.jpg")

# Full-width HTML layout
st.markdown(
    f"""
    <div style="
        display:flex; 
        ...
        gap:50px; 
        width:100%; 
        margin-top:-100px;  /* negative margin removes top gap */
        padding:0;
    ">
        <img src="data:image/png;base64,{left_wheel}" style="height:500px; margin:0; padding:0;">
        <img src="data:image/png;base64,{heading}" style="height:500px; margin:0; padding:0;">
        <img src="data:image/png;base64,{right_wheel}" style="height:500px; margin:0; padding:0;">
    </div>
    """,
    unsafe_allow_html=True
)
